...
<#
    .SYNOPSIS
        Gets Splunk Enterprise URL and returns available packages.

    .DESCRIPTION
        Gets Splunk Enterprise URL and returns available packages based on a regular expression and contents found in "data-link".
...
<#
    ...
    .DESCRIPTION
        Gets Splunk Enterprise Binary provided as an Input.
